...
libs.tmdb_movie_info = function (id, lang) {
    return __awaiter(_this, void 0, void 0, function () {
        var configData, API_KEY, url, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, libs.request_get("https://raw.githubusercontent.com/chenjipo/myprovider/refs/heads/main/dist/configs/data.json")];
                case 1:
                    configData = _a.sent();
...
libs.tmdb_tv_info = function (id, lang) {
    return __awaiter(_this, void 0, void 0, function () {
        var configData, API_KEY, url, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
