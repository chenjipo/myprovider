...
subs.getResource = function (movieInfo, config, callback) {
    return __awaiter(_this, void 0, void 0, function () {
        var PROVIDER, subLang, subLanguageIds, url, _i, subLanguageIds_1, item, urlLang, responseLang, dataLang, _a, dataLang_1, itemLang, fileName, lang, season, episode, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!movieInfo.imdb_id) return [2];
                    url = "https://rest.opensubtitles.org/search/imdbid-" + movieInfo.imdb_id.replace("tt", "");
                ...
                case 2:
                    ...
                    urlLang = "https://rest.opensubtitles.org/search/imdbid-" + movieInfo.imdb_id.replace("tt", "") + "/sublanguageid-" + item.id;
                ...
                case 4:
                    dataLang = _b.sent();
                    libs.log({ urlLang: urlLang, item: item }, PROVIDER, "RESULT");
                    for (_a = 0, dataLang_1 = dataLang; _a < dataLang_1.length; _a++) {
                        ...
                        if (movieInfo.type == "tv") {
                            ...
                            if (movieInfo.season !== season || movieInfo.episode !== episode) continue;
                        }
                        if (!subLang[lang]) continue;
                        if (!itemLang.ZipDownloadLink) continue;
                        callback({
